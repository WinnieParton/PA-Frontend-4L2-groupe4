...
import { Button, Card, Modal,Form, Row, Col, Tabs, Tab, Table, ButtonGroup } from "react-bootstrap";
    ...
    >
      ...
      <Table striped bordered hover>
        ...
        {senders.map((el) => (
            ...
            <td><Button variant="outline-danger">Annuler</Button></td>
            </tr>
            ))}
        </tbody>
        </Table>
      ...
      <Table striped bordered hover>
        ...
        {receivers.map((el) => (
            ...
            <td>
            <ButtonGroup>
      <Button variant="outline-success" >Accepter</Button>
        ...
        <Modal.Header closeButton>
          ...
          <Form>
            <Form.Group className="mb-3" controlId="username">
              ...
              <Button variant="primary" className='mt-2' onClick={handleSearch} >  Recherche </Button>
            </Form.Group>
            </Form>
